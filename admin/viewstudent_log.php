        ...
        <main class="main-content">
            <header class="header-container">
                ...
                <div class="header-right">
                    <p>
                        Total Hours Worked: <strong><?php echo $total_hours; ?></strong>
                    </p>
                </div>
            </header>
                ...
                <table id="studentsTable">
                    <thead>
                        <tr>
                            ...
                            <th>Status 
                            <div class="dropdown">
                        <img src="../assets/image/drop-status.png" alt="Filter Status" style="width: 24px; height: 24px; cursor: pointer; margin-right: 5px;">
